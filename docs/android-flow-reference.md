...
7. **Before killing:** the kernel reclaims. It drops clean file pages, and swaps anonymous pages to **zram** (compressed RAM swap; Android's "swap" is usually RAM squeezing itself). `kswapd` does this in background.
